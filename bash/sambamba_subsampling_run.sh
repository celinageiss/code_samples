...
COV_TABLE="$1"  # contains coverages and tumor cell content
...
do
	...
	qsub -o "$LOG_FILE" -j oe -l walltime=10:00:00,vmem=1G,mem=1G,nodes=1:ppn=8 -v "THRESHOLD=$THRESHOLD,BAM_FILE=$BAM_FILE,OUTPUT=$OUTPUT" wrapper_sambamba_subsampling.sh
done